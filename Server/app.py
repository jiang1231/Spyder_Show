...
def create_app():
    ...
    def homepage():
        ...
        count = COUNT
        find = db.news.find().sort({'insert_time':-1}).limit(count)
        allNews = []
    ...
    def mcf():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'足球','team':u'皇马'}).sort({'insert_time':-1}).limit(count)
    ...
    def manutd():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'足球','team':u'曼联'}).sort({'insert_time':-1}).limit(count)
        count = min(find.count(), COUNT)
        allNews = []
        for i in range(count):
            oneNews = {}
    ...
    def bar():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'足球','team':u'巴萨'}).sort({'insert_time':-1}).limit(count)
        count = min(find.count(), COUNT)
        allNews = []
        for i in range(count):
            oneNews = {}
    ...
    def hr():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'篮球','team':u'休斯顿火箭队'}).sort({'insert_time':-1}).limit(count)
        count = min(find.count(), COUNT)
        allNews = []
        for i in range(count):
            oneNews = {}
    ...
    def lal():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'篮球','team':u'湖人队'}).sort({'insert_time':-1}).limit(count)
        count = min(find.count(), COUNT)
        allNews = []
        for i in range(count):
            oneNews = {}
    ...
    def cb():
        #count = db.news.find().count()
        find = db.news.find({'sports':u'篮球','team':u'芝加哥公牛队'}).sort({'insert_time':-1}).limit(count)
        count = min(find.count(), COUNT)
        allNews = []
        for i in range(count):
            oneNews = {}
